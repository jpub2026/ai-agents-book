# Appendix A: 프로덕션 배포 (참고 자료)

> 이 부록은 본문에는 포함되지 않았지만, 에이전트 시스템을 실제 서비스로 배포할 때 참고할 수 있는
> **로깅·Slack 알림·Docker 배포 자동화** 예제입니다. 기본 개념은 Chapter 7까지의 코드로 충분히
> 학습할 수 있으며, 본 부록은 "한 단계 더" 적용해 보고 싶은 독자를 위한 자료입니다.
...
Appendix B에서는 RAG, 프롬프트 최적화, 엣지 배포 등 고급 기법을 다룹니다.
