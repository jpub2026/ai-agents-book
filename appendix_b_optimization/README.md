# Appendix B: 고급 최적화 기법 (참고 자료)

> 이 부록은 본문에는 포함되지 않았지만, 에이전트 시스템을 실제 서비스 수준으로 끌어올릴 때
> 참고할 수 있는 **RAG · 다국어 처리 · 프롬프트 최적화 · 엣지 배포** 예제 모음입니다. 모든 코드는
> 독립 실행 가능하며, 본문 학습을 마친 뒤 관심 있는 주제만 골라 읽으시기를 권합니다.
...
이 부록의 기법들을 Chapter 5-7 및 Appendix A와 결합하면 프로덕션급 AI 에이전트 시스템을 완성할 수 있습니다!
